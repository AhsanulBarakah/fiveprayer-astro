...
export default function PrayerTimesClient({ initialData, initialError }: PrayerTimesClientProps) {
  const [prayerData, setPrayerData] = useState<PrayerTimesResponse | null>(initialData);
